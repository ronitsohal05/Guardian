...
export default function StoreLogin() {
  ...
  const [formData, setFormData] = useState<StoreLoginData>({
    email: '',
    password: '',
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await storeAuthService.login(formData)
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="mt-6 text-center text-gray-600">
            ...
            <a href="/store/register" className="text-blue-600 hover:text-blue-700 font-semibold">
              Register here
            </a>
          </p>
        </div>
